...
export function Waves({
    ...
    pointerSize = 0.5,
    colors = ["#ffc64f", "#6bb9d4", "#084463", "#a3ddf0", "#436c7c"] // Colorful palette matching the site
}: WavesProps) {
    ...
    const setLines = () => {
        ...
        for (let i = 0; i < totalLines; i++) {
            ...
            // Assign a color from the colorful array
    ...
    return (
        ...
        >
            ...
            />
            {/* The cursor dot - using the first color of the palette */}
            <div
